...
Bible provides $\sim$7,000--8,000 verse-aligned pairs per language.
Tail Bible scores are at floor for all methods due to limited tail-language coverage
in the Bible retrieval index (tail Acc@10 $\leq 0.9$ for all methods).
...
NER learning rate $2\times10^{-5}$ with Adam and English-only fine-tuning matches the Glot500 paper.
