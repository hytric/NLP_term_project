% auto-generated step-wise init comparison tables in Table 6 format (B.1)
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{10K score (step별 init/group 비교; XLM baseline 포함).}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{20K score (step별 init/group 비교; XLM baseline 포함).}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{30K score (step별 init/group 비교; XLM baseline 포함).}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{40K score (step별 init/group 비교; XLM baseline 포함).}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{50K score (step별 init/group 비교; XLM baseline 포함).}
