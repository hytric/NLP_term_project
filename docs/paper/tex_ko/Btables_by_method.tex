% auto-generated per-init step trajectory tables (B.2)
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{초기화 \rand의 step별 head/tail/all 요약.}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{초기화 \meanm의 step별 head/tail/all 요약.}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{초기화 \fvt의 step별 head/tail/all 요약.}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{초기화 \wfvt의 step별 head/tail/all 요약.}
...
\begin{table}[H]\centering\small\setlength{\tabcolsep}{4pt}
\caption{초기화 \famm의 step별 head/tail/all 요약.}
