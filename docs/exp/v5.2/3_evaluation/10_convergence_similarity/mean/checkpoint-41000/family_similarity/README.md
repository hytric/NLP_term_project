...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step41000 | tail_head_different_family_different_script | 1856 | 0.908002 | -0.064495 |
| v52_mean_conv5way_step41000 | tail_head_different_family_same_script | 6100 | 0.913046 | -0.042939 |
| v52_mean_conv5way_step41000 | tail_head_same_family | 1050 | 0.927609 | 0.052829 |
| v52_mean_conv5way_step41000 | tail_head_same_macro_family | 1550 | 0.922096 | -0.047592 |
| v52_mean_conv5way_step41000 | tail_tail_different_family | 900 | 0.914326 | 0.081141 |
| v52_mean_conv5way_step41000 | tail_tail_same_family | 50 | 0.945925 | 0.262338 |
| v52_mean_conv5way_step41000 | tail_tail_same_macro_family | 100 | 0.934075 | 0.142187 |
| v52_mean_conv5way_step41000 | tail_within_language | 350 | 0.954295 | 0.461872 |
