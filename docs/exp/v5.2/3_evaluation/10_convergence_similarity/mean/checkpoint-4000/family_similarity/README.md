...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step4000 | tail_head_different_family_different_script | 1856 | 0.902092 | -0.070330 |
| v52_mean_conv5way_step4000 | tail_head_different_family_same_script | 6100 | 0.907704 | -0.046007 |
| v52_mean_conv5way_step4000 | tail_head_same_family | 1050 | 0.921820 | 0.043163 |
| v52_mean_conv5way_step4000 | tail_head_same_macro_family | 1550 | 0.915848 | -0.056163 |
| v52_mean_conv5way_step4000 | tail_tail_different_family | 900 | 0.914266 | 0.110168 |
| v52_mean_conv5way_step4000 | tail_tail_same_family | 50 | 0.944407 | 0.287367 |
| v52_mean_conv5way_step4000 | tail_tail_same_macro_family | 100 | 0.932298 | 0.157670 |
| v52_mean_conv5way_step4000 | tail_within_language | 350 | 0.952487 | 0.468291 |
