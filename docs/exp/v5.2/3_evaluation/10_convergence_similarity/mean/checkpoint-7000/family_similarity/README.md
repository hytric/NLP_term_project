...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step7000 | tail_head_different_family_different_script | 1856 | 0.901469 | -0.067692 |
| v52_mean_conv5way_step7000 | tail_head_different_family_same_script | 6100 | 0.906858 | -0.045408 |
| v52_mean_conv5way_step7000 | tail_head_same_family | 1050 | 0.923113 | 0.056899 |
| v52_mean_conv5way_step7000 | tail_head_same_macro_family | 1550 | 0.917064 | -0.049010 |
| v52_mean_conv5way_step7000 | tail_tail_different_family | 900 | 0.910087 | 0.089853 |
| v52_mean_conv5way_step7000 | tail_tail_same_family | 50 | 0.944312 | 0.283846 |
| v52_mean_conv5way_step7000 | tail_tail_same_macro_family | 100 | 0.931998 | 0.150604 |
| v52_mean_conv5way_step7000 | tail_within_language | 350 | 0.952280 | 0.468190 |
