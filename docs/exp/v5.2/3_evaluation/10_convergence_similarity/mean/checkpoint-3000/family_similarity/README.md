...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step3000 | tail_head_different_family_different_script | 1856 | 0.902217 | -0.072019 |
| v52_mean_conv5way_step3000 | tail_head_different_family_same_script | 6100 | 0.907024 | -0.046124 |
| v52_mean_conv5way_step3000 | tail_head_same_family | 1050 | 0.921729 | 0.035662 |
| v52_mean_conv5way_step3000 | tail_head_same_macro_family | 1550 | 0.916357 | -0.060069 |
| v52_mean_conv5way_step3000 | tail_tail_different_family | 900 | 0.911984 | 0.110544 |
| v52_mean_conv5way_step3000 | tail_tail_same_family | 50 | 0.944513 | 0.281687 |
| v52_mean_conv5way_step3000 | tail_tail_same_macro_family | 100 | 0.932237 | 0.160891 |
| v52_mean_conv5way_step3000 | tail_within_language | 350 | 0.951601 | 0.464265 |
