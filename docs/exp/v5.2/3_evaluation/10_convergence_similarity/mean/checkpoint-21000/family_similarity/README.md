...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step21000 | tail_head_different_family_different_script | 1856 | 0.906405 | -0.065562 |
| v52_mean_conv5way_step21000 | tail_head_different_family_same_script | 6100 | 0.911630 | -0.043125 |
| v52_mean_conv5way_step21000 | tail_head_same_family | 1050 | 0.926516 | 0.052508 |
| v52_mean_conv5way_step21000 | tail_head_same_macro_family | 1550 | 0.920988 | -0.047059 |
| v52_mean_conv5way_step21000 | tail_tail_different_family | 900 | 0.913145 | 0.082195 |
| v52_mean_conv5way_step21000 | tail_tail_same_family | 50 | 0.945316 | 0.260707 |
| v52_mean_conv5way_step21000 | tail_tail_same_macro_family | 100 | 0.933281 | 0.143406 |
| v52_mean_conv5way_step21000 | tail_within_language | 350 | 0.953708 | 0.462571 |
