...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step15000 | tail_head_different_family_different_script | 1856 | 0.904767 | -0.064992 |
| v52_mean_conv5way_step15000 | tail_head_different_family_same_script | 6100 | 0.910046 | -0.042700 |
| v52_mean_conv5way_step15000 | tail_head_same_family | 1050 | 0.925042 | 0.053287 |
| v52_mean_conv5way_step15000 | tail_head_same_macro_family | 1550 | 0.919471 | -0.046600 |
| v52_mean_conv5way_step15000 | tail_tail_different_family | 900 | 0.911689 | 0.080177 |
| v52_mean_conv5way_step15000 | tail_tail_same_family | 50 | 0.944401 | 0.265492 |
| v52_mean_conv5way_step15000 | tail_tail_same_macro_family | 100 | 0.932701 | 0.145388 |
| v52_mean_conv5way_step15000 | tail_within_language | 350 | 0.953250 | 0.463926 |
