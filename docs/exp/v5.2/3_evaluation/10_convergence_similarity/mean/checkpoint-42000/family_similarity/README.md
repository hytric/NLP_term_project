...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step42000 | tail_head_different_family_different_script | 1856 | 0.907931 | -0.064392 |
| v52_mean_conv5way_step42000 | tail_head_different_family_same_script | 6100 | 0.912954 | -0.042865 |
| v52_mean_conv5way_step42000 | tail_head_same_family | 1050 | 0.927523 | 0.052708 |
| v52_mean_conv5way_step42000 | tail_head_same_macro_family | 1550 | 0.922022 | -0.047465 |
| v52_mean_conv5way_step42000 | tail_tail_different_family | 900 | 0.914259 | 0.081080 |
| v52_mean_conv5way_step42000 | tail_tail_same_family | 50 | 0.945892 | 0.262012 |
| v52_mean_conv5way_step42000 | tail_tail_same_macro_family | 100 | 0.934056 | 0.142372 |
| v52_mean_conv5way_step42000 | tail_within_language | 350 | 0.954226 | 0.461462 |
