...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step39000 | tail_head_different_family_different_script | 1856 | 0.907859 | -0.064441 |
| v52_mean_conv5way_step39000 | tail_head_different_family_same_script | 6100 | 0.912900 | -0.042919 |
| v52_mean_conv5way_step39000 | tail_head_same_family | 1050 | 0.927491 | 0.052755 |
| v52_mean_conv5way_step39000 | tail_head_same_macro_family | 1550 | 0.922010 | -0.047315 |
| v52_mean_conv5way_step39000 | tail_tail_different_family | 900 | 0.914200 | 0.081066 |
| v52_mean_conv5way_step39000 | tail_tail_same_family | 50 | 0.945834 | 0.261567 |
| v52_mean_conv5way_step39000 | tail_tail_same_macro_family | 100 | 0.934053 | 0.142625 |
| v52_mean_conv5way_step39000 | tail_within_language | 350 | 0.954227 | 0.461686 |
