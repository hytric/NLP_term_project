...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step1000 | tail_head_different_family_different_script | 1856 | 0.903290 | -0.073225 |
| v52_mean_conv5way_step1000 | tail_head_different_family_same_script | 6100 | 0.908604 | -0.045949 |
| v52_mean_conv5way_step1000 | tail_head_same_family | 1050 | 0.921866 | 0.025691 |
| v52_mean_conv5way_step1000 | tail_head_same_macro_family | 1550 | 0.915740 | -0.071564 |
| v52_mean_conv5way_step1000 | tail_tail_different_family | 900 | 0.918261 | 0.136935 |
| v52_mean_conv5way_step1000 | tail_tail_same_family | 50 | 0.947963 | 0.310415 |
| v52_mean_conv5way_step1000 | tail_tail_same_macro_family | 100 | 0.936146 | 0.180562 |
| v52_mean_conv5way_step1000 | tail_within_language | 350 | 0.953556 | 0.464693 |
