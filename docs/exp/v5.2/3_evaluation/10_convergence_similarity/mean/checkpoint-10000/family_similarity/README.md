...
| --- | --- | ---: | ---: | ---: |
| v52_mean_conv5way_step10000 | tail_head_different_family_different_script | 1856 | 0.902881 | -0.070226 |
| v52_mean_conv5way_step10000 | tail_head_different_family_same_script | 6100 | 0.908228 | -0.045099 |
| v52_mean_conv5way_step10000 | tail_head_same_family | 1050 | 0.923571 | 0.046727 |
| v52_mean_conv5way_step10000 | tail_head_same_macro_family | 1550 | 0.917815 | -0.052774 |
| v52_mean_conv5way_step10000 | tail_tail_different_family | 900 | 0.911849 | 0.098865 |
| v52_mean_conv5way_step10000 | tail_tail_same_family | 50 | 0.944633 | 0.274654 |
| v52_mean_conv5way_step10000 | tail_tail_same_macro_family | 100 | 0.932501 | 0.157780 |
| v52_mean_conv5way_step10000 | tail_within_language | 350 | 0.952707 | 0.467718 |
