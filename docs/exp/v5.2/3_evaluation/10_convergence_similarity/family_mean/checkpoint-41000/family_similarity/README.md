...
| --- | --- | ---: | ---: | ---: |
| v52_family_mean_conv5way_step41000 | tail_head_different_family_different_script | 1856 | 0.901217 | -0.076342 |
| v52_family_mean_conv5way_step41000 | tail_head_different_family_same_script | 6100 | 0.907656 | -0.043903 |
| v52_family_mean_conv5way_step41000 | tail_head_same_family | 1050 | 0.927651 | 0.062053 |
| v52_family_mean_conv5way_step41000 | tail_head_same_macro_family | 1550 | 0.920448 | -0.049640 |
| v52_family_mean_conv5way_step41000 | tail_tail_different_family | 900 | 0.907676 | 0.083080 |
| v52_family_mean_conv5way_step41000 | tail_tail_same_family | 50 | 0.945120 | 0.276271 |
| v52_family_mean_conv5way_step41000 | tail_tail_same_macro_family | 100 | 0.934617 | 0.148042 |
| v52_family_mean_conv5way_step41000 | tail_within_language | 350 | 0.954472 | 0.483568 |
