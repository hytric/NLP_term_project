...
| --- | --- | ---: | ---: | ---: |
| v52_weighted_fvt_conv5way_step41000 | tail_head_different_family_different_script | 1856 | 0.908904 | -0.063065 |
| v52_weighted_fvt_conv5way_step41000 | tail_head_different_family_same_script | 6100 | 0.913397 | -0.039918 |
| v52_weighted_fvt_conv5way_step41000 | tail_head_same_family | 1050 | 0.929271 | 0.050514 |
| v52_weighted_fvt_conv5way_step41000 | tail_head_same_macro_family | 1550 | 0.924112 | -0.045447 |
| v52_weighted_fvt_conv5way_step41000 | tail_tail_different_family | 900 | 0.913033 | 0.071503 |
| v52_weighted_fvt_conv5way_step41000 | tail_tail_same_family | 50 | 0.945455 | 0.258237 |
| v52_weighted_fvt_conv5way_step41000 | tail_tail_same_macro_family | 100 | 0.936998 | 0.149584 |
| v52_weighted_fvt_conv5way_step41000 | tail_within_language | 350 | 0.953880 | 0.451102 |
