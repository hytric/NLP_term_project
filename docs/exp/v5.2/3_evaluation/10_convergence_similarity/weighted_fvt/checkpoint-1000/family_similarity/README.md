...
| --- | --- | ---: | ---: | ---: |
| v52_weighted_fvt_conv5way_step1000 | tail_head_different_family_different_script | 1856 | 0.903131 | -0.077495 |
| v52_weighted_fvt_conv5way_step1000 | tail_head_different_family_same_script | 6100 | 0.907267 | -0.050274 |
| v52_weighted_fvt_conv5way_step1000 | tail_head_same_family | 1050 | 0.923496 | 0.029097 |
| v52_weighted_fvt_conv5way_step1000 | tail_head_same_macro_family | 1550 | 0.918173 | -0.067928 |
| v52_weighted_fvt_conv5way_step1000 | tail_tail_different_family | 900 | 0.914402 | 0.131581 |
| v52_weighted_fvt_conv5way_step1000 | tail_tail_same_family | 50 | 0.949211 | 0.309856 |
| v52_weighted_fvt_conv5way_step1000 | tail_tail_same_macro_family | 100 | 0.936724 | 0.183306 |
| v52_weighted_fvt_conv5way_step1000 | tail_within_language | 350 | 0.952513 | 0.466538 |
