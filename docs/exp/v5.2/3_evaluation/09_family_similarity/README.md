...
- pair rows: `11956`
- models: `v52_random_step4000, v52_mean_step4000, v52_fvt_step4000`
...
| --- | --- | ---: | ---: | ---: |
| v52_fvt_step4000 | tail_head_different_family_different_script | 1856 | 0.908656 | -0.078834 |
| v52_fvt_step4000 | tail_head_different_family_same_script | 6100 | 0.913029 | -0.049819 |
| v52_fvt_step4000 | tail_head_same_family | 1050 | 0.928114 | 0.036947 |
| v52_fvt_step4000 | tail_head_same_macro_family | 1550 | 0.922911 | -0.063871 |
| v52_fvt_step4000 | tail_tail_different_family | 900 | 0.919252 | 0.123785 |
| v52_fvt_step4000 | tail_tail_same_family | 50 | 0.950288 | 0.306983 |
| v52_fvt_step4000 | tail_tail_same_macro_family | 100 | 0.939912 | 0.181989 |
| v52_fvt_step4000 | tail_within_language | 350 | 0.955939 | 0.473229 |
| v52_mean_step4000 | tail_head_different_family_different_script | 1856 | 0.909300 | -0.081205 |
| v52_mean_step4000 | tail_head_different_family_same_script | 6100 | 0.914299 | -0.053130 |
| v52_mean_step4000 | tail_head_same_family | 1050 | 0.926350 | 0.020440 |
| v52_mean_step4000 | tail_head_same_macro_family | 1550 | 0.920660 | -0.080363 |
| v52_mean_step4000 | tail_tail_different_family | 900 | 0.926486 | 0.169048 |
| v52_mean_step4000 | tail_tail_same_family | 50 | 0.953052 | 0.338241 |
| v52_mean_step4000 | tail_tail_same_macro_family | 100 | 0.941214 | 0.195629 |
| v52_mean_step4000 | tail_within_language | 350 | 0.958004 | 0.484068 |
| v52_random_step4000 | tail_head_different_family_different_script | 1856 | 0.903405 | -0.096438 |
| v52_random_step4000 | tail_head_different_family_same_script | 6100 | 0.909296 | -0.059951 |
| v52_random_step4000 | tail_head_same_family | 1050 | 0.922020 | -0.000824 |
| v52_random_step4000 | tail_head_same_macro_family | 1550 | 0.916301 | -0.097348 |
| v52_random_step4000 | tail_tail_different_family | 900 | 0.924713 | 0.208022 |
| v52_random_step4000 | tail_tail_same_family | 50 | 0.952583 | 0.367259 |
| v52_random_step4000 | tail_tail_same_macro_family | 100 | 0.940503 | 0.239189 |
| v52_random_step4000 | tail_within_language | 350 | 0.956587 | 0.497095 |
