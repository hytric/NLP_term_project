...
| train steps per run | 1600 |
| target train tokens | 500000 |
| batch size | 8 |
| eval batch size | 8 |
...
| adapted/original diagnostic ratio | 1.964580 |
| train token range | 500008-500407 |
| token budget matched | yes |
...
Observed evidence: adapted_improved=3/3, diagnostic_ratio=1.964580, margin=1.100000, token_ratio=1.000798
