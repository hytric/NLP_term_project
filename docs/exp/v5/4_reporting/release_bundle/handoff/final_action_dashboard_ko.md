...
| claim_lock | target10 downstream improves | locked | disallowed while target10 downstream coverage is 0/10; surface_overclaim=surface_overclaim_guard_ready | keep wording guarded until claim-promotion matrix unlocks it |
