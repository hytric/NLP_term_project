...
Balanced high-resource + target10 corpus로 SentencePiece unigram `32000` auxiliary tokenizer를 학습하고, XLM-R-base 기존 vocab id를 보존한 상태에서 새 token만 append한 첫 main candidate를 만들었다.

## Candidate

| Item | Value |
| --- | --- |
| variant | `main_added_32000` |
| tokenizer path | `/home/axt/mnt2/jongha/third_try/tokenizers/stage03_targetheavy_20260613_r2/tokenizers/xlmr_third_try_mixture_added_32000` |
| base vocab size | 250002 |
| actual added tokens | 18645 |
| extended vocab size | 268647 |
| avg tokens/word delta | -27.142361% |
| avg single-char ratio delta | 40.109278% |
