...
Run id: step06_downstream_20260613_154443
...
| --- | --- | --- |
| retrieval recall@1 avg | 0.022037 | 0.021778 |
| parallel matching AUC avg | 0.570167 | 0.571741 |
| book/genre accuracy avg | 1.000000 | 1.000000 |

## Downstream Success Decision

Retrieval improves: `False`.

Parallel matching improves: `True`.
